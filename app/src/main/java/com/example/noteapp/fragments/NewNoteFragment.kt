...
import com.example.noteapp.RussianPeasantMultiplicationTransformer
...
class NewNoteFragment : Fragment(R.layout.fragment_new_note) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnTransformer.setOnClickListener {
            val noteX = binding.etNoteTitle.text.toString().toInt()
            val noteY = binding.etNoteContent.text.toString().toInt()

            val transformer = RussianPeasantMultiplicationTransformer()
            val result = transformer.rmp(noteX, noteY)
            binding.tvDisplayRPM.setText(result.toString())
        }
    }
